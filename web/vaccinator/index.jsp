                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <%
                                try
                                {
                                    PreparedStatement pst1=conn.prepareStatement("SELECT * FROM tbl_vaccination INNER JOIN tbl_member ON tbl_vaccination.member_id=tbl_member.member_id INNER JOIN tbl_vaccine ON tbl_vaccination.vaccine_id=tbl_vaccine.vaccine_id WHERE vaccinator_id=? AND vaccination_status='Approved'");
                            ...
                            %>
                        <a title="Update vaccination status" href="vaccination_update.jsp?vaccination_id=<% out.println(rs1.getString("vaccination_id")); %>" onclick="return confirm('Are you sure?')"><i class="ri ri-checkbox-circle-line"></i></a>
                            <%
                                            out.println("</td></tr>");
                                        }
                                    }
            ...
            <div class="card recent-sales overflow-auto">
                <div class="card-body">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <%
                                    PreparedStatement pst2=conn.prepareStatement("SELECT * FROM tbl_vaccination INNER JOIN tbl_member ON tbl_vaccination.member_id=tbl_member.member_id INNER JOIN tbl_vaccine ON tbl_vaccination.vaccine_id=tbl_vaccine.vaccine_id WHERE vaccinator_id=? AND vaccination_status='Vaccinated'");
                                    pst2.setInt(1,(Integer)session.getAttribute("vaccinator_id"));
                                    ...
                                    else
                                    {
                                        while(rs2.next())
                                        {
                                            ...
                                            out.println("<td>"+rs2.getString("vaccination_status")+"</td>");
