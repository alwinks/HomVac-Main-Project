...
<%
    ...
    PreparedStatement pst1=conn.prepareStatement("SELECT * FROM tbl_vaccination WHERE vaccinator_id=? AND vaccination_date=? AND vaccination_time=?");
    pst1.setString(1,request.getParameter("vaccinator_id"));
    pst1.setString(2,request.getParameter("vaccination_date"));
    pst1.setString(3,request.getParameter("vaccination_time"));
