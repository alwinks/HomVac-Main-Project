...
<%
        ...
        PreparedStatement pst=conn.prepareStatement("INSERT INTO tbl_health_centre(health_centre_name,health_centre_reg_no,health_centre_latitude,health_centre_longitude,health_centre_phone,health_centre_username,health_centre_password,health_centre_status) VALUES(?,?,?,?,?,?,?,Not verified'Pending')");
