...
<html lang="en">
    ...
    <head>
        ...
        <title>Register as User - HomVac</title>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="register_action.jsp" class="row g-3 needs-validation" novalidate>
                                            <div class="col-12">
                                                ...
                                                <input required type="text" name="user_name" class="form-control" required>
                                                <div class="invalid-feedback">Please, enter your name!</div>
                                            </div>

                                            <div class="col-12">
                                                <label for="user_mobile" class="form-label">Your Mobile Number</label>
                                                <input required type="number" name="user_mobile" class="form-control" required>
                                                <div class="invalid-feedback">Please enter a valid mobile number!</div>
                                            </div>

                                            <div class="col-12">
                                                <label for="user_password" class="form-label">Password</label>
                                                <input required type="password" name="user_password" class="form-control" required>
