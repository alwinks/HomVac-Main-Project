                    ...
                    <div class="tab-content pt-2">
                        ...
                        <div class="tab-pane fade show active profile-overview" id="profile-overview">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-8"><% out.println(rs.getString("user_name")); %></div>
                            </div>
                            ...
                            <form action="profile_update.jsp">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <input name="user_name" type="text" class="form-control" value="<% out.println(rs.getString("user_name")); %>">
                                    </div>
                                </div>

                                <div class="row mb-3">
                                    <label for="user_mobile" class="col-md-4 col-lg-3 col-form-label">Mobile Number</label>
                                    <div class="col-md-8 col-lg-9">
                                        <input name="user_mobile" type="text" class="form-control" value="<% out.println(rs.getString("user_mobile")); %>">
                                    </div>
                                </div>
